...
const ExpertLoginScreen = ({ navigation }) => {
  ...
  // This handleLogin function is now hardcoded for the 'doctor' role
  const handleLogin = () => {
    if (!email || !password) {
    ...
    login(email, password, 'doctor', navigation); 
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        {/* --- CHANGED: Title is now specific to Doctor/Expert --- */}
        <Text style={styles.title}>Doctor / Expert Login</Text>
        ...
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Text style={styles.goBackText}>
            Not a Doctor? <Text style={{ fontWeight: 'bold' }}>Go Back</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
// Styles are identical to the AdminLoginScreen
